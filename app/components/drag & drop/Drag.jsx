...
const Drag = () => {
    ...
    // Load upload history from local storage on component mount
        ...
        function handleSendToHeadPerson() {
            ...
            const filesToSend = [...selectedFiles, ...uploadHistory.map(upload => upload.handle)];
 ...
 return (
    ...
    <div className="flex flex-col gap-10 border rounded-md bg-gray-50 p-10">
        <div className="flex flex-col items-center gap-2">
            <RxUpload size={25} onClick={handleClick}/>
            <p className="font-medium">Upload your files here</p>
        </div>
        <hr />
        <div className="flex flex-col gap-5">
            ...
            <div>
                ...
                {uploadHistory.map((upload) => (
                        <li key={upload.handle} className="flex flex-col">
                        ...
                        <div className="flex gap-16">
                            <button
                                ...
                                onClick={()=> window.open(`https://cdn.filestackcontent.com/${upload.handle}`)}
                            >
                                View
                            </button>
                            ...
                            <VscSend size={20} className="mt-2" onClick={handleSendToHeadPerson}/>
                        </div>
                            <hr className="my-5"/>
                        </li>
                    ))}
